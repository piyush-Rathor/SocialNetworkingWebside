                        ...
                        if (v.State.calls[o]) {
                            ...
                            for (var g = Math.min((e - h) / d.duration, 1), y = 0, x = s.length; x > y; y++) {
                                ...
                                if (a(S)) {
                                    ...
                                    for (var M in d.visibility !== n && "hidden" !== d.visibility && b.setPropertyValue(S, "visibility", d.visibility), k)
                                        if ("element" !== M) {
                                            var T, P = k[M],
                                            ...
                                            if (P.currentValue = T, "tween" === M) m = T;
                                                ...
                                                if (b.Hooks.registered[M]) {
                                                    var _ = b.Hooks.getRoot(M),
                                                        O = a(S).rootPropertyValueCache[_];
                                                    O && (P.rootPropertyValue = O)
                                                }
                                                var D = b.setPropertyValue(S, M, P.currentValue + (0 === parseFloat(T) ? "" : P.unitType), P.rootPropertyValue, P.scrollData);
                ...
                var x = function () {
                    ...
                    function r() {
                        function t(t) {
                                ...
                                for (var E in a(r).tweensContainer && !0 === a(r).isAnimating && (_ = a(r).tweensContainer), u.each(y, function (t, e) {
                                    ...
                                    if (a(r).isSVG || "tween" === z || !1 !== b.Names.prefixCheck(z)[1] || b.Normalizations.registered[z] !== n) {
                                        ...
                                        if (V = (H = f(E, V))[0], B = H[1], $ = (H = f(E, $))[0].replace(/^([+-\/*])=/, function (t, e) {
                                                return Y = e, ""
                                            }), j = H[1], V = parseFloat(V) || 0, $ = parseFloat($) || 0, "%" === j && (/^(fontSize|lineHeight)$/.test(E) ? ($ /= 100, j = "em") : /^scale/.test(E) ? ($ /= 100, j = "") : /(Red|Green|Blue)$/i.test(E) && ($ = $ / 100 * 255, j = "")), /[\/*]/.test(Y)) j = B;
                                        else if (B !== j && 0 !== V)
                                            if (0 === $) j = B;
                                            else {
                                                o = o || m();
                            ...
                            d.element && (b.Values.addClass(r, "velocity-animating"), R.push(d), "" === c.queue && (a(r).tweensContainer = d, a(r).opts = c), a(r).isAnimating = !0, C === S - 1 ? (v.State.calls.push([R, g, c, null, P.resolver]), !1 === v.State.isTicking && (v.State.isTicking = !0, l())) : C++)
                        }
                        var o, r = this,
                    ...
                    if (p.isWrapped(this) ? (d = !1, f = 0, g = this, h = this) : (d = !0, f = 1, g = k ? arguments[0].elements || arguments[0].e : arguments[0]), g = o(g)) {
                        ...
                        switch (d && v.Promise && (P.promise = new v.Promise(function (t, e) {
                                ...
                                if (!u.isPlainObject(y) || p.isEmptyObject(y)) {
                                    if (p.isString(y) && v.Redirects[y]) {
                                        ...
                                        return !0 === E.backwards && (g = u.extend(!0, [], g).reverse()), u.each(g, function (t, e) {
                                            parseFloat(E.stagger) ? E.delay = _ + parseFloat(E.stagger) * t : p.isFunction(E.stagger) && (E.delay = _ + E.stagger.call(e, t, S)), E.drag && (E.duration = parseFloat(A) || (/^(callout|transition)/.test(y) ? 1e3 : m), E.duration = Math.max(E.duration * (E.backwards ? 1 - t / S : (t + 1) / S), .75 * E.duration, 200)), v.Redirects[y].call(e, e, E || {}, t, S, g, P.promise ? P : n)
                                        }), t()
                                    }
                                    var O = "Velocity: First argument (" + y + ") was not a property map, a known action, or a registered redirect. Aborting.";
                                    return P.promise ? P.rejecter(new Error(O)) : console.log(O), t()
                                }
                                T = "start"
                        }
                        var D, E, L = {
                        ...
                        if (u.each(g, function (t, e) {
                            ...
                            for (var F = 0; D > F; F++) {
                                ...
                                F === D - 1 && ($.display = E.display, $.visibility = E.visibility, $.complete = E.complete), x(g, "reverse", $)
                            }
                        return t()
                    }
                };
                    ...
                    draw: function (t) {
                        ...
                        if (i.display) {
                            var o = e.ctx,
                                ...
                                _ = "bottom" === i.position ? e.top + P : e.bottom - w - P,
                                O = "bottom" === i.position ? e.top + P + w : e.bottom + P;
                            if (a.each(g, function (n, o) {
                                    if (!a.isNullOrUndef(n.label)) {
                                        ...
                                        if (m) {
                                            ...
                                            z < e.left && (u = "rgba(0,0,0,0)"), z += a.aliasPixel(c), E = e.getPixelForTick(o) + s.labelOffset, v = b = k = C = z, y = _, x = O, S = t.top, D = t.bottom + P
                                        } else {
                                            ...
                                            j < e.top && (u = "rgba(0,0,0,0)"), j += a.aliasPixel(c), L = e.getPixelForTick(o) + s.labelOffset, v = I, b = A, k = t.left, C = t.right + P, y = x = S = D = j
                                        }
                                        T.push({
                                            tx1: v,
                                            ty1: y,
                                ...
                                var D, E, L = 0,
                                    R = d(p) / 2;
                                if (m) D = e.left + (e.right - e.left) / 2, E = "bottom" === i.position ? e.bottom - R - C.bottom : e.top + R + C.top;
                                else {
                ...
                var l = o.extend({
                    ...
                    draw: function () {
                        ...
                        if (o.display) {
                            ...
                            var w = o.text;
                            if (a.isArray(w))
                                for (var k = 0, S = 0; S < w.length; ++S) e.fillText(w[S], 0, k, s), k += f;
...
dropdownSelectors.on({
            ...
            n = function () {
                function n(o, a) {
                    _classCallCheck(this, n), this.defaults = {
                        ...
                        closeOnClick: !1,
                        breakpoint: i
                    }, this.$element = o, this.options = this.assignOptions(a), this.menuOut = !1, this.lastTouchVelocity = {
                        x: {
                            startPosition: 0,
                            startTime: 0,
                            endPosition: 0,
                ...
                return _createClass(n, [{
                    ...
                    value: function () {
                        ...
                        this.$element.on("click", function (i) {
                            if (i.preventDefault(), !0 === e.menuOut) e.menuOut = !1, e.removeMenu();
                                ...
                                e.menuOut = !0, e.$sidenavOverlay = t('<div id="sidenav-overlay"></div>'), e.$body.append(e.$sidenavOverlay);
                                var n = [];
                    ...
                    value: function () {
                        ...
                        "left" === this.options.edge ? (this.$menu.css("transform", "translateX(-100%)"), this.$dragTarget.css({
                            ...
                            right: 0
                        })), this.$menu.hasClass("fixed") && (window.innerWidth > this.options.breakpoint && this.$menu.css("transform", "translateX(0)"), t(window).resize(function () {
    ...
    function (t) {
        var e, i = "input[type=range]:not(.custom-range)",
            n = !1;
        t(document).on("change", i, function () {
            ...
            if (!r.length && function () {
                    ...
                    t(i).after(e)
                }(), r.find(".value").html(a.val()), n = !0, a.addClass("active"), r.hasClass("active") || r.velocity({
                    height: "30px",
                    width: "30px",
                    top: "-20px",
                    marginLeft: "-15px"
            ...
            return _createClass(e, [{
                ...
                value: function (e, i) {
                    var n = e.is(":disabled") ? "disabled" : "",
                        ...
                        a = e.data("icon"),
                        r = e.data("fas") ? '<i class="fas fa-'.concat(e.data("fas"), '"></i> ') : "",
                        s = e.attr("class"),
                ...
                value: function () {
                    var e = this,
                        i = t(this.$toggleAll).find('input[type="checkbox"]').first(),
                        n = !t(i).prop("checked");
    ...
    function () {
        ...
        function C(t, e) {
            var i, o, r = n(S),
                ...
                C = r.find(".clockpicker-minutes"),
                T = r.find(".clockpicker-am-pm-block"),
                P = "INPUT" === t.prop("tagName"),
                I = P ? t : t.find("input"),
                A = (I.prop("type"), n("label[for=" + I.attr("id") + "]")),
                _ = this;
            if (this.id = (o = ++g + "", (i = "cp") ? i + o : o), this.element = t, this.holder = c, this.options = e, this.isAppended = !1, this.isShown = !1, this.currentView = "hours", this.isInput = P, this.input = I, this.label = A, this.popover = r, this.plate = l, this.hoursView = p, this.minutesView = C, this.amPmBlock = T, this.spanHours = r.find(".clockpicker-span-hours"), this.spanMinutes = r.find(".clockpicker-span-minutes"), this.spanAmPm = r.find(".clockpicker-span-am-pm"), this.footer = r.find(".picker__footer"), this.amOrPm = "", e.twelvehour) {
            ...
            e.darktheme && r.addClass("darktheme"), n('<button type="button" class="btn btn-flat clockpicker-button" tabindex="' + (e.twelvehour ? "3" : "1") + '">' + e.donetext + "</button>").click(n.proxy(this.done, this)).appendTo(this.footer), n('<button type="button" class="btn btn-flat clockpicker-button" tabindex="' + (e.twelvehour ? "4" : "2") + '">' + e.cleartext + "</button>").click(n.proxy(this.clearInput, this)).appendTo(this.footer), this.spanHours.click(n.proxy(this.toggleView, this, "hours")), this.spanMinutes.click(n.proxy(this.toggleView, this, "minutes")), I.on("focus.clockpicker click.clockpicker", n.proxy(this.show, this));
            var D, E, L, R, F = n('<div class="clockpicker-tick"></div>');
            if (e.twelvehour)
                for (D = 0; D < 12; D += e.hourstep) E = F.clone(), L = D / 6 * Math.PI, R = y, E.css("font-size", "140%"), E.css({
                    left: v + Math.sin(L) * R - x,
                    top: v - Math.cos(L) * R - x
                }), E.html(0 === D ? 12 : D), p.append(E), E.on(u, V);
            else
            ...
            if (l.on(u, function (t) {
                ...
                var X = f("circle");
                X.setAttribute("class", "clockpicker-canvas-fg"), X.setAttribute("r", 5), H.appendChild(B), H.appendChild(Y), H.appendChild(X), H.appendChild(j), N.appendChild(H), z.append(N), this.hand = B, this.bg = Y, this.fg = X, this.bearing = j, this.g = H, this.canvas = z
            }
            M(this.options.init)
        }
    ...
    function (t, e) {
        ...
        return function (t, e, i, n) {
            ...
            o.extend(r, n);
            var s, l, c, u, d, h, p, f, m, g, v, y, b, x, w, k, S, C, M, T, P, I, A, _, O, D, E, L, R, F, $, W, V, z, N, H, j, B, Y, X, q, U, Q, Z, K, G, J, tt, et, it, nt, ot, at, rt, st, lt = {
                    x: 0,
                    y: 0
                },
                ct = {
                ...
                Zt = {
                    ...
                    init: function () {
                        if (!s && !l) {
                            var i;
                            a.framework = o, a.template = t, a.bg = o.getChildByClass(t, "pswp__bg"), E = t.className, s = !0, $ = o.detectFeatures(), O = $.raf, D = $.caf, I = $.transform, R = $.oldIE, a.scrollWrap = o.getChildByClass(t, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), d = a.container.style, a.itemHolders = k = [{
                                ...
                                function () {
                                    if (I) {
                                        var e = $.perspective && !_;
                                        return y = "translate" + (e ? "3d(" : "("), void(b = $.perspective ? ", 0px)" : ")")
                                    }
                                    I = "left", o.addClass(t, "pswp--ie"), _t = function (t, e) {
                                        e.left = t + "px"
                                    }, At = function (t) {
                            ...
                            for ($.animationName && $.transform && !n || (r.showAnimationDuration = r.hideAnimationDuration = 0), i = 0; i < vt.length; i++) a["init" + vt[i]]();
                            e && (a.ui = new e(a, o)).init(), Ct("firstUpdate"), u = u || r.index || 0, (isNaN(u) || 0 > u || u >= ze()) && (u = 0), a.currItem = Ve(u), ($.isOldIOSPhone || $.isOldAndroid) && (gt = !1), t.setAttribute("aria-hidden", "false"), r.modal && (gt ? t.style.position = "fixed" : (t.style.position = "absolute", t.style.top = o.getScrollY() + "px")), void 0 === F && (Ct("initialLayout"), F = L = o.getScrollY());
                            var c = "pswp--open ";
                            for (r.mainClass && (c += r.mainClass + " "), r.showHideOpacity && (c += "pswp--animate_opacity "), c += _ ? "pswp--touch" : "pswp--notouch", c += $.animationName ? " pswp--css_animation" : "", c += $.svg ? " pswp--svg" : "", o.addClass(t, c), a.updateSize(), h = -1, mt = null, i = 0; 3 > i; i++) _t((i + h) * ft.x, k[i].el.style);
                            R || o.bind(a.scrollWrap, f, a), St("initialZoomInEnd", function () {
                                a.setContent(k[0], u - 1), a.setContent(k[2], u + 1), k[0].el.style.display = k[2].el.style.display = "block", r.focus && t.focus(), o.bind(document, "keydown", a), $.transform && o.bind(a.scrollWrap, "click", a), r.mouseUsed || o.bind(document, "mousemove", Ft), o.bind(window, "resize scroll", a), Ct("bindEvents")
                    ...
                    close: function () {
                        s && (s = !1, l = !0, Ct("close"), o.unbind(window, "resize", a), o.unbind(window, "scroll", m.scroll), o.unbind(document, "keydown", a), o.unbind(document, "mousemove", Ft), $.transform && o.unbind(a.scrollWrap, "click", a), B && o.unbind(window, p, a), Ct("unbindEvents"), Ne(a.currItem, null, !0, a.destroy))
                    },
                    destroy: function () {
                    ...
                    updateSize: function (e) {
                        ...
                        v = g = a.currItem.initialZoomLevel, (J = a.currItem.bounds) && (ut.x = J.center.x, ut.y = J.center.y, It(!0)), Ct("resize")
                    },
                ...
                Me = function (t, e) {
                    var i, n, o, s, l = ut[t] + e[t],
                        ...
                        u = ce.x + e.x,
                        d = ce.x - ne.x;
                    return i = l > J.min[t] || l < J.max[t] ? r.panEndFriction : 1, l = ut[t] + e[t] * i, !r.allowPanToNext && g !== a.currItem.initialZoomLevel || (tt ? "h" !== it || "x" !== t || X || (c ? (l > J.min[t] && (i = r.panEndFriction, J.min[t], n = J.min[t] - ct[t]), (0 >= n || 0 > d) && ze() > 1 ? (s = u, 0 > d && u > ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l)) : (l < J.max[t] && (i = r.panEndFriction, J.max[t], n = ct[t] - J.max[t]), (0 >= n || d > 0) && ze() > 1 ? (s = u, d > 0 && u < ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l))) : s = u, "x" !== t) ? void(et || Q || g > a.currItem.fitRatio && (ut[t] += e[t] * i)) : (void 0 !== s && (Ot(s, !0), Q = s !== ne.x), J.min.x !== J.max.x && (void 0 !== o ? ut.x = o : Q || (ut.x += e.x * i)), void 0 !== s)
                },
                Te = function (t) {
                    if (!("mousedown" === t.type && t.button > 0)) {
                        ...
                        if (!j || "mousedown" !== t.type) {
                            ...
                            var i = Ce(t),
                                n = i.length;
                            Z = null, Ut(), B && 1 !== n || (B = nt = !0, o.bind(window, p, a), N = rt = ot = H = Q = q = Y = X = !1, it = null, Ct("firstTouchStart", i), Et(ct, ut), lt.x = lt.y = 0, Et(te, i[0]), Et(ee, te), ne.x = ft.x * ht, oe = [{
                                x: te.x,
                                y: te.y
                            }], V = W = Mt(), $t(g, !0), pe(), fe()), !K && n > 1 && !et && !Q && (v = g, X = !1, K = Y = !0, lt.y = lt.x = 0, Et(ct, ut), Et(Kt, i[0]), Et(Gt, i[1]), be(Kt, Gt, de), ue.x = Math.abs(de.x) - ut.x, ue.y = Math.abs(de.y) - ut.y, G = he(Kt, Gt))
                        }
                    }
                },
                Pe = function (t) {
                    ...
                    if (Z) {
                        ...
                        if (0 !== t)
                            if (Et(Kt, Z[0]), Jt.x = Kt.x - te.x, Jt.y = Kt.y - te.y, K && t > 1) {
                                ...
                                Et(Gt, Z[1]), X || (X = !0, Ct("zoomGestureStarted"));
                                var e = he(Kt, Gt),
                                    i = Ee(e);
                                ...
                                0 > n && (n = 0), be(Kt, Gt, se), lt.x += se.x - de.x, lt.y += se.y - de.y, Et(de, se), ut.x = Dt("x", i), ut.y = Dt("y", i), N = i > g, g = i, It()
                            } else {
                                if (!it) return;
                                ...
                                if ("v" === it && r.closeOnVerticalDrag && "fit" === r.scaleMode && g === a.currItem.initialZoomLevel) {
                                    lt.y += Jt.y, ut.y += Jt.y;
                                    var c = xe();
                                    return H = !0, Ct("onVerticalDrag", c), Tt(c), void It()
                                }(function (t, e, i) {
                                    if (t - V > 50) {
                                        var n = oe.length > 2 ? oe.shift() : {};
                                        n.x = e, n.y = i, oe.push(n), V = t
                                    }
                                })(Mt(), Kt.x, Kt.y), q = !0, J = a.currItem.bounds, Me("x", Jt) || (Me("y", Jt), Lt(ut), It())
                            }
                    }
                },
                Ae = function (t) {
                    ...
                    var c = -1;
                    if (0 === l && (B = !1, o.unbind(window, p, a), pe(), K ? c = 0 : -1 !== le && (c = Mt() - le)), le = 1 === l ? Mt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", K && 2 > l && (K = !1, 1 === l && (n = "zoomPointerUp"), Ct("zoomGestureEnded")), Z = null, q || X || et || H)
                        if (Ut(), z || (z = _e()), z.calculateSwipeSpeed("x"), H)
                ...
                _e = function () {
                    var t, e, i = {
                        ...
                        panAnimLoop: function () {
                            return Bt.zoomPan && (Bt.zoomPan.raf = O(i.panAnimLoop), i.now = Mt(), i.timeDiff = i.now - i.lastNow, i.lastNow = i.now, i.calculateAnimOffset("x"), i.calculateAnimOffset("y"), It(), i.calculateOverBoundsAnimOffset("x"), i.calculateOverBoundsAnimOffset("y"), i.speedDecelerationRatioAbs.x < .05 && i.speedDecelerationRatioAbs.y < .05) ? (ut.x = Math.round(ut.x), ut.y = Math.round(ut.y), It(), void Xt("zoomPan")) : void 0
                        }
                    };
                    return i
                },
                ...
                publicMethods: {
                    initGestures: function () {
                        var t = function (t, e, i, n, o) {
                            C = t + e, M = t + i, T = t + n, P = o ? t + o : ""
                        };
                        (A = $.pointerEvent) && $.touch && ($.touch = !1), A ? navigator.pointerEnabled ? t("pointer", "down", "move", "up", "cancel") : t("MSPointer", "Down", "Move", "Up", "Cancel") : $.touch ? (t("touch", "start", "move", "end", "cancel"), _ = !0) : t("mouse", "down", "move", "up"), p = M + " " + T + " " + P, f = C, A && !_ && (_ = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1), a.likelyTouchDevice = _, m[C] = Te, m[M] = Pe, m[T] = Ae, P && (m[P] = m[T]), $.touch && (f += " mousedown", p += " mousemove mouseup", m.mousedown = m[C], m.mousemove = m[M], m.mouseup = m[T]), _ || (r.allowPanToNext = !1)
                    }
                }
            });
            var Re, Fe, $e, We, Ve, ze, Ne = function (e, i, n, s) {
                    ...
                    var d = n ? r.hideAnimationDuration : r.showAnimationDuration,
                        h = function () {
                            Xt("initialZoom"), n ? (a.template.removeAttribute("style"), a.bg.removeAttribute("style")) : (Tt(1), i && (i.style.display = "block"), o.addClass(t, "pswp--animated-in"), Ct("initialZoom" + (n ? "OutEnd" : "InEnd"))), s && s(), We = !1
                        };
                    if (!d || !l || void 0 === l.x) return Ct("initialZoom" + (n ? "Out" : "In")), g = e.initialZoomLevel, Et(ut, e.initialPosition), It(), t.style.opacity = n ? 0 : 1, Tt(1), void(d ? setTimeout(function () {
                        h()
                    }, d) : h());
                    ! function () {
                        var i = c,
                            s = !a.currItem.src || a.currItem.loadError || r.showHideOpacity;
                        e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (g = l.w / e.w, ut.x = l.x, ut.y = l.y - L, a[s ? "template" : "bg"].style.opacity = .001, It()), qt("initialZoom"), n && !i && o.removeClass(t, "pswp--animated-in"), s && (n ? o[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function () {
                            ...
                            } else g = e.initialZoomLevel, Et(ut, e.initialPosition), It(), Tt(1), s ? t.style.opacity = 1 : Tt(1), Re = setTimeout(h, d + 20)
                        }, n ? 25 : 90)
                    }()
                },
                He = {},
            ...
            xt("Controller", {
                publicMethods: {
                    lazyLoadItem: function (t) {
                        t = wt(t);
                        var e = Ve(t);
                        e && (!e.loaded && !e.loading || w) && (Ct("gettingData", t, e), e.src && qe(e))
                    },
                    ...
                    setContent: function (t, e) {
                        ...
                        if (l) {
                            ...
                            if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Ue(l), Ye(l, dt), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((n = o.createEl("pswp__img", "img")).style.opacity = 1, n.src = l.src, Qe(l, n), Xe(0, l, c, n));
                            else {
                                if (l.loadComplete = function (i) {
                                        if (s) {
                                            if (t && t.index === e) {
                                                if (Ue(i, !0)) return i.loadComplete = i.img = null, Ye(i, dt), At(i), void(t.index === u && a.updateCurrZoomItem());
                                                i.imageAppended ? !We && i.placeholder && (i.placeholder.style.display = "none", i.placeholder = null) : $.transform && (et || We) ? je.push({
                                                    item: i,
                                                    baseDiv: c,
                                                    img: i.img,
                                                    index: e,
                                ...
                                l.loading || qe(l), a.allowProgressiveImg() && (!$e && $.transform ? je.push({
                                    item: l,
                                    baseDiv: c,
                                    img: l.img,
                                    index: e,
            ...
            x.init = function () {
                e.extend(t.options, C, !0), g = t.options, n = e.getChildByClass(t.scrollWrap, "pswp__ui"), d = t.listen,
                    ...
                    function () {
                        ...
                        r && a(r.children)
                    }(), g.shareEl && s && l && (S = !0), I(), g.timeToIdle && d("mouseUsed", function () {
                        e.bind(document, "mousemove", R), e.bind(document, "mouseout", F), y = setInterval(function () {
                            2 == ++L && x.setIdle(!0)
                        }, g.timeToIdle / 2)
                    }), g.fullscreenEl && !e.features.isOldAndroid && (i || (i = x.getFullscreenAPI()), i ? (e.bind(document, i.eventK, x.updateFullscreen), x.updateFullscreen(), e.addClass(t.template, "pswp--supports-fs")) : e.removeClass(t.template, "pswp--supports-fs")), g.preloaderEl && ($(!0), d("beforeChange", function () {
                ...
                k && t.currItem ? (x.updateIndexIndicator(), g.captionEl && (g.addCaptionHTMLFn(t.currItem, o), P(o, "caption--empty", !t.currItem.title)), w = !0) : w = !1, S || _(), I()
        ...
        t(document).ready(function () {
            ...
            return this.$el = t(this), this.$document = t(document), this.eventsHandled = !1, this.defaultOptions = {
                ...
                this.$document.on("click", this.selectors.chips, function (i) {
                    ...
                    if (i.which === e.keyCodes.enter) return i.preventDefault(), e.addChip(a, {
                        tag: n.val()
                    }, o), void n.val("");
        ...
        var w = !!t.ResizeObserver && new t.ResizeObserver(function (t) {
            ...
            C = function (t) {
                ...
                for (var e = arguments[1], i = Array.prototype.slice.call(arguments, 2), n = t.length, o = 0, r = void 0; o < n; o++)
                    if ("object" === (void 0 === e ? "undefined" : a(e)) || void 0 === e ? t[o].jarallax || (t[o].jarallax = new S(t[o], e)) : t[o].jarallax && (r = t[o].jarallax[e].apply(t[o].jarallax, i)), void 0 !== r) return r;
                return t
            };
    ...
    function a(t) {
        ...
        return t = $.extend({
            ...
            var n, o = $(i),
                ...
                c = t.inputFocus,
                u = t.inputBlur,
                d = t.inputFocusShadow,
                h = t.inputBlurShadow;
            Object.keys(a).length && (n = $('<ul class="mdb-autocomplete-wrap"></ul>')).insertAfter(o), o.on("focus", function () {
                o.css("border-bottom", c), o.css("box-shadow", d)
            }), o.on("blur", function () {
                o.css("border-bottom", u), o.css("box-shadow", h)
            }), o.on("keyup", function (t) {
                var e = o.val();
                if (n.empty(), e.length)
                    for (var i in a)
                        if (-1 !== a[i].toLowerCase().indexOf(e.toLowerCase())) {
                            var s = $("<li>".concat(a[i], "</li>"));
                            n.append(s)
                        } 13 === t.which && (n.children(":first").trigger("click"), n.empty()), 0 === e.length ? o.parent().find(".mdb-autocomplete-clear").css("visibility", "hidden") : o.parent().find(".mdb-autocomplete-clear").css("visibility", "visible"), $(".mdb-autocomplete-wrap li").css("color", r)
            }), n.on("click", "li", function (t) {
                o.val($(t.target).text()), n.empty()
            }), $(".mdb-autocomplete-clear").on("click", function (t) {
                t.preventDefault();
                var e = $(t.currentTarget);
                e.parent().find(".mdb-autocomplete").val(""), e.css("visibility", "hidden"), n.empty(), e.parent().find("label").removeClass("active")
            }), $(".mdb-autocomplete").on("click keyup", function (t) {
                t.preventDefault(), $(t.target).parent().find(".mdb-autocomplete-clear").find("svg").css("fill", s)
            }), $(".mdb-autocomplete").on("blur", function (t) {
                t.preventDefault(), $(t.target).parent().find(".mdb-autocomplete-clear").find("svg").css("fill", l)
            })
        })
